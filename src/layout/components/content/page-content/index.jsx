...
export default function PageContent(props) {
  ...
  return (
    <Col span={24} className="hp-bg-black-bg hp-py-sm-40 hp-py-40 hp-px-sm-24 hp-px-md-40 hp-px-80 hp-overflow-hidden" style={{paddingTop: 30, paddingBottom: 30, marginBottom: 40, borderRadius: 32 }}>
      <svg
        width={358}
        height={336}
        fill="none"
          ...
          <Row>
            {
              title && (
                <Col span={24}>
                  <h3 className="hp-mb-0 hp-text-color-black-0">{title}</h3>
                </Col>
              )
            }
              ...
              breadcrumb && (
                <Col span={24}>
                  <Breadcrumb className="hp-d-flex hp-flex-wrap hp-mt-24">
                    <Breadcrumb.Item>
                      <Link to="/" className="hp-text-color-black-0 hp-hover-text-color-primary-2">Dahsboard</Link>
                    </Breadcrumb.Item>
