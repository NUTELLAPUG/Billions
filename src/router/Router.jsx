...
import SignUp from "../view/pages/authentication/register/index";
import AdminComponent from "../view/main/dashboard/admin";
...
export default function Router() {
    ...
    const ResolveRoutes = () => {
        return Object.keys(Layouts).map((layout, index) => {
            ...
            } else if (DefaultLayout === "HorizontalLayout" && layout === "VerticalLayout") {
                LayoutTag = Layouts["HorizontalLayout"];
            } else {
